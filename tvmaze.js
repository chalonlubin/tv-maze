...
var DEFAULT_IMG = "https://www.clipartkey.com/mpngs/m/152-1520367_user-profile-default-image-png-clipart-png-download.png";
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, axios_1.default)({
                        url: "".concat(API_URL, "search/shows?q=").concat(term),
                        method: "GET",
                    })];
                case 1:
                    response = _a.sent();
...
function getEpisodesOfShow(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, axios_1.default)({
                        url: "".concat(API_URL, "shows/").concat(id, "/episodes"),
                        method: "GET",
                    })];
                case 1:
                    response = _a.sent();
                    return [2 /*return*/, response.data.map(function (result) {
                            var show = result.episode;
                            console.log(show);
                            return {
                                id: show.id,
                                name: show.name,
...
$('.Show-getEpisodes').on('click', 'button', function (evt) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    evt.preventDefault();
                    return [4 /*yield*/, populateEpisodes()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
